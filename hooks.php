 ...
 * 
 * @package KsfFA_ksf_FA_Shipping
 * @version 2.4.3
 */

define('SS_ksf_FA_Shipping', 136 << 8);

class hooks_ksf_FA_Shipping extends hooks {
    var $module_name = 'ksf_FA_Shipping';
    var $version = '1.0.0';
    ...
    function install_tabs($app) {
        ...
        // return new ksf_FA_Shipping_app();
    }
    ...
    function install_access() {
        $security_sections[SS_ksf_FA_Shipping] = _("");
        $security_areas['SA_ksf_FA_ShippingVIEW'] = array(
            SS_ksf_FA_Shipping | 1, 
            _("View ")
        );
        $security_areas['SA_ksf_FA_ShippingMANAGE'] = array(
            SS_ksf_FA_Shipping | 2, 
            _("Manage ")
        );
